...
from transformers.generation_beam_search import BeamScorer, ConstrainedBeamSearchScorer
from transformers.generation_utils import *
from transformers.pytorch_utils import torch_int_div
from transformers.utils import ModelOutput, logging

from src.utils.transformers import ExplainerOutput
...
class GenerationMixin:
    ...
    def generate(
        self,
        nle: Optional[ExplainerOutput] = None,
