...
python src/experiments/esnli_test.py --data_frac=.05 --input_dir=$input_dir --num_attn_heads=2
python src/experiments/esnli_test.py --data_frac=1.0 --input_dir=$input_dir --num_attn_heads=2 --out_suffix=-full