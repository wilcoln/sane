...
input_dir='results/trainers/2022-08-22_17-38-32_173930_model=SANE_dataset=esnli_num_epochs=5_batch_size=64_lr=0.0001_weight_decay=0.01_sent_dim=768_hidden_dim=64_max_concepts_per_sent=200_sentence_pool=mean_data_frac=0.05_alpha=0.4_beta=0.5_num_attn_heads=1'
python tests/esnli_test.py --input_dir=$input_dir
