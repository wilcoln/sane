import torch
from transformers import BartConfig, BartModel, PretrainedBartModel, BartForConditionalGeneration
...
class BartForExplanationGeneration(BartForConditionalGeneration):
    ...
    Examples::
        ...
        lm_logits = F.linear(torch.cat([outputs[0], knowledge_embedding], dim=1), self.model.shared.weight, bias=self.final_logits_bias)
        # add
